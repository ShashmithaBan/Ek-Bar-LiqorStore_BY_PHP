...
<body>
<div id="preloader">
        <img id="preloader-gif" src="source/head.gif" alt="Preloader GIF">
    </div>
    <header id="main-content" class="main-content">
        <div class="nav-container">
            <nav>
                ...
                <li>
                    <a href="catogories_wine.php">Wines</a>
                </li>
                <li>
                    <a href="catogories_alchol.php">Alchol</a>
                </li>
                <li>
                ...
                <li>
                     <a href="cart.php" class="nav-wishlist"></a>
                </li>
                <li>
                    <a href = "addproduct.php" class = "add">Add Product</a>
                </li>
                <li><a href="include/logout.inc.php" class="logout">Logout</a>
                </li>
               </ul>
            </nav>
        </div>
